...
/* lwp functions */
tid_t lwp_create(lwpfun,void *,size_t); /* create new lwp */
void  lwp_exit(void);                   /* terminate calling lwp */
tid_t lwp_gettid(void);                 /* return thread id of calling lwp */
void  lwp_yield(void);                  /* yield CPU for another lwp */
